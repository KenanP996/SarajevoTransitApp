...
class Komercijala : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homeButton.setOnClickListener {
            val intent = Intent(this@Komercijala, MainActivity::class.java)
            startActivity(intent)
        }

        ticketsButton.setOnClickListener {
            val intent = Intent(this@Komercijala, Transport::class.java)
            startActivity(intent)
        }

        departuresButton.setOnClickListener {
            val intent = Intent(this@Komercijala, RouteTypes::class.java)
            startActivity(intent)
        }

        val closestStationsButton = findViewById<ImageButton>(R.id.mapa)
        closestStationsButton.setOnClickListener {
            val intent = Intent(this@Komercijala, MapActivity::class.java)
            startActivity(intent)
        }
    }

    private fun getTramTicketTypes(): List<tickets> {
        return ticket_options.ticket_types().filter { it.tot_id == 3 }
    }
